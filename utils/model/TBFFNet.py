...
class TBFFNet(nn.Module):
    def __init__(self, num_classes=7):
        ...
        initialize_weights(self.lcm_decoder, self.lcm_classifier1)
    ...
    def forward(self, x1):
        ...
        return F.interpolate(out1, x_size[2:], mode='bilinear')
...
if __name__ == "__main__":
    ...
    output_lcm1 = model(dummy_input1)
    print("LCM1 Output Shape:", output_lcm1.shape)

    model_compile = torch.compile(model)
    output_lcm1_compile = model_compile(dummy_input1)
    print("LCM1 Compile Output Shape:", output_lcm1_compile.shape)